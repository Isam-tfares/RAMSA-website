                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <form action="index.php" method="post">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="email" id="typeEmailX-2" class="form-control form-control-lg" name="email" required placeholder="enter votre email" oninput="this.value = this.value.replace(/\s/g, '')" value="<?php echo (isset($_POST['id'])) ? explode("-", $_POST['id'])[0] : "" ?>" />
                                    <!-- <label class="form-label" for="typeEmailX-2">Email</label> -->
                                </div>

                                <div class="form-outline mb-4">
                                    <input type="password" id="typePasswordX-2" class="form-control form-control-lg" name="password" required placeholder="enter votre mot de passe" maxlength="20" oninput="this.value = this.value.replace(/\s/g, '')" value="<?php echo (isset($_POST['id'])) ? explode("-", $_POST['id'])[1] : "" ?>" />
                                ...
                                <div class="form-check d-flex justify-content-start mb-4">
                                    ...
                                    <label class="form-check-label" for="form1Example3"> Souviens moi </label>
                                </div>
